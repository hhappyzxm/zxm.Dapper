...
namespace zxm.Dapper.SqlGenerator
{
        ...
        where TEntity : class
    {
        ...
        private void InitSqlConnector(zxm.Dapper.SqlGenerator.ESqlConnector sqlConnector)
        {
            SqlConnector = sqlConnector;
            switch (SqlConnector)
            {
                case zxm.Dapper.SqlGenerator.ESqlConnector.MSSQL:
                    ...
                    break;
                case zxm.Dapper.SqlGenerator.ESqlConnector.MySQL:
                    break;
                case zxm.Dapper.SqlGenerator.ESqlConnector.PostgreSQL:
                    //todo: ковычки
                    break;
                default:
        ...
        private StringBuilder InitBuilderSelect(bool firstOnly)
        {
            ...
            if (firstOnly && SqlConnector == zxm.Dapper.SqlGenerator.ESqlConnector.MSSQL)
                select += "TOP 1 ";
